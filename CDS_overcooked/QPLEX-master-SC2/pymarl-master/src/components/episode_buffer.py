...
class EpisodeBatch:
    ...
    def __repr__(self):
        return "EpisodeBatch. Batch Size:{} Max_seq_len:{} Keys:{} Groups:{}".format(self.batch_size, self.max_seq_length,
                                                                                     self.scheme.keys(), self.groups.keys())
...
class ReplayBuffer(EpisodeBatch):
    ...
    def __repr__(self):
        return "ReplayBuffer. {}/{} episodes. Keys:{} Groups:{}".format(self.episodes_in_buffer, self.buffer_size, self.scheme.keys(),
                                                                        self.groups.keys())
    ...
    def save(self, path_name):
        ...
        file_name = path_name + 'meta.json'
        meta = {'buffer_index': self.buffer_index, 'episodes_in_buffer': self.episodes_in_buffer, 'buffer_size': self.buffer_size}
